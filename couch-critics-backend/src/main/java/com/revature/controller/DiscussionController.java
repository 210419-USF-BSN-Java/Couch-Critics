...
public class DiscussionController {
	...
	// Receives a Discussion object id
	// Returns a boolean. True if execution was successful.
	@DeleteMapping(value="/delete/{id}")
	public ResponseEntity<Boolean> deleteDiscussionById(@PathVariable("id") Integer id){
		Boolean b = ds.deleteDiscussion(id);
